export const TRANSLATIONS_EN = {
  ...
  global: {
    ...
    errorToken: "You are not authorized to access this page",
  },
  app: {
  ...
  errorPage: {
    ...
    text: "We apologize for the inconvenience, but it seems that we are experiencing a technical issue. Our team is already aware of this problem and is actively working to resolve it.",
  },
  searchBox: {
  ...
  billDetails: {
    pay: "Pay",
    warningMsg: "The minimum number that can be entered is 8",
    moreDetails: "Details:",
    ...
    errorMsg:
      "There is a problem with the process, and in the case of payment, the amount paid will be refunded within days.",
    ...
    egp: " EGP ",
    serviceFees: "Fees amount : ",
    remaining: "Remaining amount:",
    total: "Total payment amount (incl. VAT): ",
